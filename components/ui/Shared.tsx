            ...
            <div className="flex items-center gap-2">
                {onToggleInfinite && (
                    <button 
                        ...
                        className={`group relative h-10 w-12 border flex items-center justify-center transition-all duration-200 ${
                            isInfinite 
                    ...
                    >
                        ...
                        <div className={`absolute top-1 right-1 w-1 h-1 rounded-none transition-all duration-300 ${
                            isInfinite 

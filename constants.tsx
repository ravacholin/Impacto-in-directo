...
export const MODULES: Module[] = [
  ...
  },
  {
    id: 'posicion',
    title: 'Posición',
    description: 'Coloca el pronombre en el lugar correcto del verbo.',
    icon: PositionIcon,
    exercises: [
      {
        id: 'pronoun-position',
        title: 'Posición',
        description: 'Delante del verbo conjugado e imperativo negativo; pegado al infinitivo, gerundio e imperativo afirmativo.',
        type: ExerciseType.PRONOUN_POSITION,
        data: []
      }
    ]
  },
  {
    ...
    description: 'Contestá preguntas reales con el pronombre correcto.',
    icon: ChatIcon,
    exercises: [
      {
        id: 'quick-response',
  ...
  },
  {
    id: 'oido',
    title: 'Oído',
    description: 'Escuchá la frase y elegí el clítico que suena. Los pronombres son átonos: cuestan de oír.',
    icon: SpeakerIcon,
    exercises: [
      {
        id: 'ear',
        title: 'Oído',
        description: 'Escuchás la frase completa; elegí el clúster que oíste entre las opciones.',
        type: ExerciseType.EAR,
        data: []
      }
    ]
  },
